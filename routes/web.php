...
Route::group(['middleware' => ['ajax-session-expired', 'auth', 'deleted_user', 'ppc', 'no.back']], function () {
	...
	Route::group(['prefix' => 'dashboard'], function () {
		...
		Route::get('/pie-graphfilter', 'PPC\DashboardController@getFilteredPieGraph')
			->name('dashboard.pie-graphfilter');
	...
	Route::group(['prefix' => 'transaction'], function () {
		...
		Route::group(['prefix' => 'rework-sheet'], function () {
			...
			Route::get('/set-up/rework-list', 'PPC\Transaction\ReworkSheetController@getJoDetails')
				->name('transaction.rework-sheet.rework-list');
			Route::get('/set-up/rework-process', 'PPC\Transaction\ReworkSheetController@getProcess')
				->name('transaction.rework-sheet.rework-process');
	...
	Route::group(['prefix' => 'reports'], function () {
		...
		Route::get('/travel-sheet-status/displayTS', 'PPC\Reports\TravelSheetStatusController@displayTravelSheet')
			->name('reports.travel-sheet-status.displayTS');
		Route::get('/travel-sheet-status/displayProdTS', 'PPC\Reports\TravelSheetStatusController@displayProdDetails')
			->name('reports.travel-sheet-status.displayProdTS');

		Route::get('/travel-sheet-status/filter-report', 'PPC\Reports\TravelSheetStatusController@filterReport')
			->name('reports.travel-sheet-status.filter-report');
...
Route::group(['prefix' => 'prod', 'middleware' => ['ajax-session-expired', 'auth', 'deleted_user', 'production','no.back',]], function () {
	...
	Route::group(['prefix' => 'production-output'], function () {
		...
		Route::get('/get-Operatorname', 'Production\Transaction\ProductionOutputController@getOperatorName')
			->name('prod.production-output.get-Operatorname');
		...
		Route::get('/check-Sequence-edit', 'Production\Transaction\ProductionOutputController@checkSequence_edit')
			->name('prod.production-output.check-Sequence-edit');
	...
	Route::group(['prefix' => 'transfer-item'], function () {
		...
		Route::get('/get-extra-divcode', 'Production\Transaction\TransferItemController@getExtraDivCode')
			->name('prod.transfer-item.get-extra-divcode');
		...
		Route::get('/get-extra-process', 'Production\Transaction\TransferItemController@getExtraProcess')
				->name('prod.transfer-item.get-extra-process');
	});
	...
	Route::group(['prefix' => 'reports'], function () {
		...
		Route::get('/operators-output/displayoperator', 'Production\Reports\OperatorsOutputController@displayOperator')
			->name('prod.reports.operators-output.displayoperator');
		Route::get('/operators-output/displayoperatorDate', 'Production\Reports\OperatorsOutputController@displayOperatorbyDate')
			->name('prod.reports.operators-output.displayoperatorDate');
		Route::get('/operators-output/getoperator', 'Production\Reports\OperatorsOutputController@GetOperationOuputList')
			->name('prod.reports.operators-output.getoperator');
		...
		Route::get('/operators-output/filter-report', 'Production\Reports\OperatorsOutputController@filterReport')
			->name('prod.reports.operators-output.filter-report');
...
Route::group(['prefix' => 'pdf'], function () {
	...
	Route::get('travel-sheet-status', 'PDFController@TSReprint')->name('pdf.travel-sheet-status');
});
