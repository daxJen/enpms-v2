...
class DashboardController extends Controller
{
  ...
  // public function filterPieGraphReport(Request $req)
  //   {
  //       return $this->getFilteredPieGraph($req);

  //   }
    public function getFilteredPieGraph(Request $req)
    {
        $srch_date_from = "NULL";
        $srch_date_to = "NULL";
        $srch_jo_sequence = "NULL";
        $srch_prod_code = "NULL";
        $srch_code_description = "NULL";
        $srch_div_code = "NULL";
        $srch_process_name = "NULL";
        ...
        if (!is_null($req->srch_date_from) && !is_null($req->srch_date_to)) {
            $srch_date_from = "'" . $req->srch_date_from . "'";
            $srch_date_to = "'" . $req->srch_date_to . "'";
        }

        if (!is_null($req->srch_jo_sequence)) {
            $srch_jo_sequence = "'" . $req->srch_jo_sequence . "'";
        }
        ...
        if (!is_null($req->srch_code_description)) {
            $srch_code_description = "'" . $req->srch_code_description . "'";
        }

        if (!is_null($req->srch_div_code)) {
            $srch_div_code = "'" . $req->srch_div_code . "'";
        }

        if (!is_null($req->srch_process_name)) {
            $srch_process_name = "'" . $req->srch_process_name . "'";
        }
        ...
        $data = DB::select(
            DB::raw("CALL dashboard_graph_filter(" . $srch_date_from . ",
                                                                " . $srch_date_to . ",
                                                                " . $srch_jo_sequence . ",
                                                                " . $srch_prod_code . ",
                                                                " . $srch_code_description . ",
                                                                " . $srch_div_code . ",
                                                                " . $srch_process_name . ",
                                                                " . $srch_material_used . ",
                                                                " . $srch_heat_no . ",
  ...
  //       return $data;
  //   }
    public function getFilteredData($req)
    {
        $srch_date_from = "NULL";
        $srch_date_to = "NULL";
        $srch_jo_sequence = "NULL";
        ...
        $data = DB::select(
            DB::raw("CALL dashboard_report(" . $srch_date_from . ",
                                                                " . $srch_date_to . ",
                                                                " . $srch_jo_sequence . ",
                                                                " . $srch_prod_code . ",
                                                                " . $srch_code_description . ",
