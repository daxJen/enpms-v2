...
$(function () {
  ...
  $('#btn_search_withdrawal').on('click', function () {
    $('#btn_save').show();
    $('#btn_cancel').show();
    MaterialsDataTable(getMaterialsURL, {
      _token: token,
      rmw_no: $('#rmw_no').val()
    });
  });
  ...
  $('#tbl_travel_sheet tbody').on('click', ' .btn_cancel_jo', function () {
    ...
    swal({
      ...
      if (isConfirm) {
        CancelTravelSheet(data); //swal("Cancelled!", "J.O. # "+jo_no+" was successfully cancelled.");
      }
    });
  });
...
function computeMaterial(object) {
  ...
  switch (object.material_type) {
    ...
    case 'PIPE':
      ...
      var prod_plate = object.cut_length * object.cut_width; // calculate material plate
...
function MaterialsDataTable(ajax_url, object_data) {
  ...
  $('#tbl_materials').DataTable({
    ...
    createdRow: function createdRow(row, data, dataIndex) {//total_withdrawal += parseFloat(data.rmw_qty);
    },
    initComplete: function initComplete() {
      $('.loadingOverlay').hide();
  ...
  $('#tbl_bom').DataTable({
    ...
    columns: [{
      data: function data(x) {
        return x.prod_code + "<input type='hidden' id='prod_code_" + count + "' class='prod_code' data-count='" + count + "' name='prod_code[]' value='" + x.prod_code + "' />" + "<input type='hidden' data-count='" + count + "' id='prod_sum_id_" + count + "' class='prod_sum_id' name='prod_sum_id[]' value='" + x.prod_sum_id + "' />" + "<input type='hidden' data-count='" + count + "' id='upd_inv_id_" + count + "' class='upd_inv_id' name='upd_inv_id[]' value='" + x.upd_inv_id + "' />" + "<input type='hidden' data-count='" + count + "' id='inv_id_" + count + "' class='inv_id' name='inv_id[]' value='" + x.inv_id + "' />" + "<input type='hidden' data-count='" + count + "' id='rmwd_id_" + count + "' class='rmwd_id' name='rmwd_id[]' value='" + x.rmwd_id + "' />" + "<input type='hidden' data-count='" + count + "' id='size_" + count + "' class='size' name='size[]' value='" + x.size + "' />" + "<input type='hidden' data-count='" + count + "' id='material_type_" + count + "' class='material_type' name='material_type[]' value='" + x.material_type + "' />" + "<input type='hidden' data-count='" + count + "' id='heat_no_" + count + "' class='heat_no' name='heat_no[]' value='" + x.heat_no + "' />" + "<input type='hidden' data-count='" + count + "' id='rmw_qty_" + count + "' class='rmw_qty' name='rmw_qty[]' value='" + x.rmw_qty + "' />" + "<input type='hidden' data-count='" + count + "' id='material_code_" + count + "' class='material_code' name='material_code[]' value='" + x.material_code + "' />" + "<input type='hidden' data-count='" + count + "' id='standard_material_used_" + count + "' class='standard_material_used' name='standard_material_used[]' value='" + x.standard_material_used + "' />" + "<input type='hidden' data-count='" + count + "' id='count_" + count + "' class='count' name='count[]' value='" + count + "' />";
      },
      orderable: false,
      searchable: false,
      width: '9.67%'
...
function saveBOM() {
  $('.loadingOverlay-modal').show();
  var param = {
    prod_sum_id: $('input[name="prod_sum_id[]"]').map(function () {
      return $(this).val();
    }).get(),
    ...
    back_order_qty: $('input[name="back_order_qty[]"]').map(function () {
      return $(this).val();
    }).get(),
    ...
    material_code: $('input[name="material_code[]"]').map(function () {
      return $(this).val();
    }).get(),
    heat_no: $('input[name="heat_no[]"]').map(function () {
      return $(this).val();
    }).get(),
    rmw_qty: $('input[name="rmw_qty[]"]').map(function () {
      return $(this).val();
    }).get(),
    ...
    mat_width: $('input[name="mat_width[]"]').map(function () {
      return $(this).val();
    }).get(),
    ...
    standard_material_used: $('input[name="standard_material_used[]"]').map(function () {
      return $(this).val();
    }).get(),
    ...
    qty_per_piece: $('input[name="qty_per_piece[]"]').map(function () {
      return $(this).val();
    }).get(),
