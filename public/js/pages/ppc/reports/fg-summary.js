  ...
  $('#tbl_fg_summary').dataTable({
    ...
    columns: [{
      data: function data(x) {
        return '<button class="btn btn-sm bg-blue btn_edit_fg" ' + 'data-id="' + x.id + '" ' + 'data-sc_no="' + x.sc_no + '" ' + 'data-jo_no="' + x.jo_no + '" ' + 'data-prod_code="' + x.prod_code + '" ' + 'data-description="' + x.description + '" ' + 'data-order_qty="' + x.order_qty + '" ' + 'data-qty="' + x.qty + '">' + '<i class="fa fa-edit"></i>' + '</button>';
      },
      searchable: false,
      orderable: false
    }, {
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\en-pms\resources\assets\js\pages\ppc\reports\fg-summary.js */"./resources/assets/js/pages/ppc/reports/fg-summary.js");
