  ...
  $('#tbl_production_ouput').dataTable({
    ...
    columns: [{
      data: function data(x) {
        row++;
        return "<button type='button' class='btn btn-lg bg-blue btn_edit_set' " + "data-id='" + x.id + "'" + "data-row='" + row + "'" + "'data-travel_sheet_id='" + x.travel_sheet_id + "'data-travel_sheet_process_id='" + x.travel_sheet_process_id + "'value='" + x.id + "'>" + "<i class='fa fa-edit'></i>" + "</button>" + " " + "<button type='button' class='btn btn-lg bg-red btn_delete_set' data-row='" + "'data-id='" + x.id + "'data-row='" + row + "'" + "'data-travel_sheet_id='" + x.travel_sheet_id + "'data-travel_sheet_process_id='" + x.travel_sheet_process_id + "'data-issued_qty='" + x.issued_qty + "'value='" + x.id + "'>" + "<i class='fa fa-times'></i>" + "</button>";
      },
      searchable: false,
      orderable: false,
      width: '3.33%' // { data: 'action', name: 'action', searchable: false, orderable: false, width: '3.33%'
