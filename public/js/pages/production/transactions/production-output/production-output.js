  ...
  $('#tbl_production_ouput').dataTable({
    ...
    columns: [{
      data: function data(x) {
        row++;
        return "<button type='button' class='btn btn-lg bg-blue btn_edit_set' " + "data-id='" + x.id + "'" + "data-row='" + row + "'" + "'data-travel_sheet_id='" + x.travel_sheet_id + "'data-travel_sheet_process_id='" + x.travel_sheet_process_id + "'data-unprocessed='" + x.unprocessed + "'data-good='" + x.good + "'data-rework='" + x.rework + "'data-scrap='" + x.scrap + "'data-reworked='" + x.nc + "'data-convert='" + x.conver + "'data-alloy_mix='" + x.alloy_mix + "'data-operator='" + x.operator + "'data-operator_name='" + x.operator_name + "'data-machine_no='" + x.machine_no + "'value='" + x.id + "'>" + "<i class='fa fa-edit'></i>" + "</button>" + " " + "<button type='button' class='btn btn-lg bg-red btn_delete_set' " + "'data-id='" + x.id + "'data-row='" + row + "'" + "'data-travel_sheet_id='" + x.travel_sheet_id + "'data-travel_sheet_process_id='" + x.travel_sheet_process_id + "'data-unprocessed='" + x.unprocessed + "'data-good='" + x.good + "'data-rework='" + x.rework + "'data-scrap='" + x.scrap + "'data-reworked='" + x.nc + "'data-convert='" + x.conver + "'data-alloy_mix='" + x.alloy_mix + "'data-operator='" + x.operator + "'data-operator_name='" + x.operator_name + "'data-machine_no='" + x.machine_no + "'value='" + x.id + "'>" + "<i class='fa fa-times'></i>" + "</button>";
      },
      searchable: false,
      orderable: false,
      width: '3.33%'
...
function edit_set() {
  var chkArray = []; // $(".check_item:checked").each(function () {
