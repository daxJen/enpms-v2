    ...
    $('#tbl_travel_sheet_status').dataTable({
        ...
        columns: [{
            ...
            return "<button class='btn btn-lg bg-blue btn_print_set'" +
               "data-ts_id='" + s.ts_id + "' " +
               "data-ts_jo_no='" + s.ts_jo_no + "' " + 
               "data-jo_sequence='" + s.jo_sequence + "' " + 
               "data-prod_order_no='" + s.sc_no + "' " + 
               "data-prod_code='" + s.prod_code + "' " + 
               "data-description='" + s.code_description + "' " + 
               "data-material_used='" + s.material_used + "' " + 
               "data-material_heat_no='" + s.material_heat_no + "' " + 
               "data-lot_no='" + s.lot_no + "' " + 
               "data-type='" + s.type1 + "' " + 
               "data-order_qty='" + s.order_qty + "' " + 
               "data-issued_qty='" + s.issued_qty + "' " + 
               "data-updated_at='" + s.updated_date + "'>" + 
          ...
          width: '3.33%'
            ...
            { data: 'fg_stocks', width: '4.33%'},
            { data: 'crude_stocks', width: '4.33%'},
            { data: 'updated_date', width: '4.33%'
       },],
