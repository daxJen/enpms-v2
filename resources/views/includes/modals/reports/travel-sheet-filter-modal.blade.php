<div id="modal_search" class="modal fade " data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <form method="GET" action="{{ url('reports/travel-sheet-status/filter-report') }}" id="frm_search">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="jo_no" class="col-sm-4 control-label mt-5">JO Number:</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group row">
                                <label for="jo_sequence" class="col-sm-4 control-label mt-5">JO Sequence:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control validate srch-clear" name="jo_sequence" id="jo_sequence">
                                    <div id="jo_sequence_feedback"></div>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="sc_no" class="col-sm-4 control-label mt-5">SC No.:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control validate srch-clear" name="sc_no" id="sc_no">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                <label for="code_description" class="col-sm-3 control-label mt-5">Description:</label>
                                <div class="col-sm-9">
                           ...
                           <!--  <div class="form-group row">
                            ...
                            <!-- <div class="form-group row">
                                <label for="process_name" class="col-sm-3 control-label mt-5">Status:</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control validate srch-clear" name="status" id="status">
